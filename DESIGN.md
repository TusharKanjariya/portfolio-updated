...
rounded:
  ...
  pill: "999px"
spacing:
  page-gutter: "clamp(16px, calc(4px + 2vw), 64px)"
  xs: "clamp(4px, calc(3px + .08vw), 6px)"
  sm: "clamp(8px, calc(6px + .2vw), 10px)"
  md: "clamp(12px, calc(8px + .4vw), 16px)"
  base: "clamp(16px, calc(10px + .5vw), 20px)"
  lg: "clamp(20px, calc(10px + .95vw), 32px)"
  xl: "clamp(24px, calc(8px + 1.7vw), 48px)"
  xxl: "clamp(32px, calc(8px + 2.5vw), 64px)"
  xxxl: "clamp(48px, calc(8px + 3.5vw), 88px)"
  display-gap: "clamp(64px, 5vw, 120px)"
  section-airy: "clamp(80px, 7.5vw, 144px)"
  section-standard: "clamp(72px, 6.25vw, 120px)"
  section-compact: "clamp(56px, 5vw, 96px)"
components:
  button-primary:
...
Personal research tooling and the sitemap utility follow in two columns. The MongoDB and PostgreSQL VectorDocs projects retain separate titles and repository links but share an introduction and a conceptual illustration of finding an answer in documents. Both are explicitly learning projects. Original 2D illustrations show calm professional activities with fine slate contours, pale blue and lavender fills, and sparse halftone shading. The cool, light palette keeps project text visually dominant. Generous margins and simple scenes remain readable at mobile sizes. Responsive WebP files are provided at 640px and 1280px wide.
